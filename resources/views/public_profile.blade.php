                        ...
                        <div class="profiles_content">
                            ...
                            <div class="profile_avatar">
                                <div class="profile_avatar_holder">
                                    <img @if ($u->image == '') src="/../person-icon.png" @else src="/profile_images/{{ $u->image }}" @endif alt="">
                                </div>
                            ...
                            <div class="profile_info">
                                ...
                                <div class="flex space-x-3 lg:flex-initial text-sm">
                                    @if (in_array($u->id, $stars))
                                        <a href="#">
                                            <ion-icon name="star" class="pr-2 text-5xl text-yellow-500"
                                                data-userid="{{ $u->id }}">
                                            </ion-icon>
                                        </a>
                                    @else
                                        <a href="#">
                                            <ion-icon name="star" class="pr-2 text-5xl"
                                                data-userid="{{ $u->id }}"></ion-icon>
                                        </a>
                                    @endif
                                    <a href="/messages/{{ $u->id }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                            width="45" height="45" class="dark:text-gray-100">
                                            <path fill-rule="evenodd"
                                                d="M18 5v8a2 2 0 01-2 2h-5l-5 4v-4H4a2 2 0 01-2-2V5a2 2 0 012-2h12a2 2 0 012 2zM7 8H5v2h2V8zm2 0h2v2H9V8zm6 0h-2v2h2V8z"
                                                clip-rule="evenodd" />
                                        </svg>
                                    </a>
                                    @if (in_array($u->id, $likes))
                                        <a href="#">
                                            <ion-icon name="heart" class="pr-2 text-5xl text-red-600"
                                                data-userid="{{ $u->id }}"></ion-icon>
                                        </a>
                                    @else
                                        <a href="#">
                                            <ion-icon name="heart" class="pr-2 text-5xl"
                                                data-userid="{{ $u->id }}"></ion-icon>
                                        </a>
                                    @endif
                                </div>
                                ...
                                <div class="bg-white w-56 shadow-md mx-auto p-2 mt-12 rounded-md text-gray-500 hidden border border-gray-100 dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700"
                                    ...
                                    <ul class="space-y-1">
                                        ...
                                        <li>
                                            <a href="#"
                                                class="flex items-center px-3 py-2 hover:bg-gray-100 hover:text-gray-800 rounded-md dark:hover:bg-gray-800">
                                                <ion-icon name="create-outline" class="pr-2 text-xl"></ion-icon>
                                                Account
                                                setting
                                            </a>
                                        </li>
                ...
                <div class="uk-switcher lg:mt-8 mt-4" id="timeline-tab">
                        ...
                        <div class="space-y-5 flex-shrink-0 md:w-7/12">
                            ...
                            <div class="card lg:mx-0 p-4" uk-toggle="target: #create-post-modal">
                                <div class="flex space-x-3">
                                    <img src="/profile_images/{{ auth()->user()->image }}"
                                        class="w-10 h-10 rounded-full">
                                    <input placeholder="¿Que estas pensando? {{ auth()->user()->name }} "
                            ...
                            <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                                ...
                                <div class="flex justify-between items-center lg:p-4 p-2.5">
                                    <div class="flex flex-1 items-center space-x-4">
                                        ...
                                        <div class="flex-1 font-semibold capitalize">
                                            ...
                                            <div class="text-gray-700 flex items-center space-x-2"> 5 <span> hrs
                                                </span>
                                ...
                                <div uk-lightbox>
                                    <a href="/../frontend/assets/images/avatars/avatar-lg-3.jpg">
                                        <img src="/../frontend/assets/images/avatars/avatar-lg-4.jpg" alt=""
                                    ...
                                    <div class="border-t py-4 space-y-4 dark:border-gray-600">
                                        <div class="flex">
                                            ...
                                            <div>
                                                <div
                                                    ...
                                                    <p class="leading-6">In ut odio libero vulputate <urna
                                                ...
                                                <div class="text-sm flex items-center space-x-3 mt-2 ml-5">
                                                    <a href="#" class="text-red-600"> <i class="uil-heart"></i>
                                                        Love </a>
                                                    <a href="#"> Replay </a>
                                                    <span> 3d </span>
                                                </div>
                                        ...
                                        <div class="flex">
                                            ...
                                            <div>
                                                <div
                                                    class="text-gray-700 py-2 px-3 rounded-md bg-gray-100 relative lg:ml-5 ml-2 lg:mr-12  dark:bg-gray-800 dark:text-gray-100">
                                                    <p class="leading-6"> sed diam nonummy nibh euismod tincidunt
                                                        ut laoreet dolore magna aliquam erat volutpat. David !<i
                            ...
                            <div class="widget card p-5">
                                ...
                                <ul class="text-gray-600 space-y-3 mt-3">
                                    <li class="flex items-center space-x-2">
                                        ...
                                        Live In <strong> {{ $u->country }} , {{ $u->city }} </strong>
                                    </li>
                                    <li class="flex items-center space-x-2">
                                        <ion-icon name="calendar" class="rounded-full bg-gray-200 text-xl p-1 mr-3">
                                        </ion-icon>
                                        Birthday
                                        <strong>{{ \Carbon\Carbon::parse($u->birthday)->format('j F, Y') }}</strong>
                                    </li>
                                    <li class="flex items-center space-x-2">
                                ...
                                <div class="gap-3 grid grid-cols-3 mt-4">
                                    <img src="/../frontend/assets/images/avatars/avatar-lg-2.jpg" alt=""
                            ...
                            <div class="widget card p-5 border-t">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-4 rounded-md -mx-2 p-2 hover:bg-gray-50">
                                        <a href="timeline-group.html"
                                            class="w-12 h-12 flex-shrink-0 overflow-hidden rounded-full relative">
                                            <img src="/../frontend/assets/images/group/group-4.jpg"
                                                class="absolute w-full h-full inset-0 " alt="">
                                        </a>
                                        <div class="flex-1">
                                            <a href="timeline-page.html" class="text-base font-semibold capitalize">
                                    ...
                                    <div class="flex items-center space-x-4 rounded-md -mx-2 p-2 hover:bg-gray-50">
                                        <a href="timeline-group.html"
                                            class="w-12 h-12 flex-shrink-0 overflow-hidden rounded-full relative">
                                            <img src="/../frontend/assets/images/group/group-2.jpg"
                                                class="absolute w-full h-full inset-0" alt="">
                                        </a>
                                        <div class="flex-1">
                                            <a href="timeline-page.html" class="text-base font-semibold capitalize">
                    ...
                    <div class="card md:p-6 p-2 max-w-3xl mx-auto">
                        ...
                        <nav class="responsive-nav border-b">
                            <ul>
                                <li class="active"><a href="#" class="lg:px-2"> All Friends <span>
                                            3,4510 </span> </a></li>
                        ...
                        <div class="flex justify-between items-start relative md:mb-4 mb-3">
                            <div class="flex-1">
                                ...
                                <nav class="responsive-nav style-2 md:m-0 -mx-4">
                                    <ul>
                                        <li class="active"><a href="#"> Photos of you <span> 230</span> </a>
                                        </li>
                    ...
                    <div class="card md:p-6 p-2 max-w-3xl mx-auto">
                        ...
                        <div class="grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-4 mt-5">
                            ...
                            <div class="card">
                                ...
                                <div class="p-3">
                                    <a href="timeline-page.html" class="text-base font-semibold mb-0.5"> John Michael
                                    </a>
                                    <p class="font-medium text-sm">843K Following </p>
                                    <button
                            ...
                            <div class="card">
                                ...
                                <div class="p-3">
                                    <a href="timeline-page.html" class="text-base font-semibold mb-0.5"> Dennis Han
                                    </a>
                                    <p class="font-medium text-sm">843K Following </p>
                                    <button
                                        class="bg-gray-100 w-full flex font-semibold h-8 items-center justify-center mt-3 px-3 rounded-md  text-sm">
                            ...
                            <div class="card">
                                ...
                                <div class="p-3">
                                    <a href="timeline-page.html" class="text-base font-semibold mb-0.5"> Monroe Parker
                                    </a>
                                    <p class="font-medium text-sm">843K Following </p>
                                    <button
                                        class="bg-gray-100 w-full flex font-semibold h-8 items-center justify-center mt-3 px-3 rounded-md  text-sm">
                            ...
                            <div class="card">
                                ...
                                <div class="p-3">
                                    <a href="timeline-page.html" class="text-base font-semibold mb-0.5"> Erica Jones
                                    </a>
                                    <p class="font-medium text-sm">843K Following </p>
                                    <button
                                        class="bg-gray-100 w-full flex font-semibold h-8 items-center justify-center mt-3 px-3 rounded-md  text-sm">
                            ...
                            <div class="card">
                                ...
                                <div class="p-3">
                                    <a href="timeline-page.html" class="text-base font-semibold mb-0.5"> Stella
                                        Johnson</a>
                                    <p class="font-medium text-sm">843K Following </p>
                                    <button
                                        class="bg-gray-100 w-full flex font-semibold h-8 items-center justify-center mt-3 px-3 rounded-md  text-sm">
                    ...
                    <div class="card md:p-6 p-2 max-w-3xl mx-auto">
                        ...
                        <div class="grid md:grid-cols-2  grid-cols-2 gap-x-2 gap-y-4 mt-3">
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    <a href="timeline-page.html" class="text-base font-semibold capitalize"> Mountain
                                        Riders </a>
                                    <div class="text-sm text-gray-500"> 54 mutual friends </div>
                                </div>
                                <button class="bg-gray-100 font-semibold py-2 px-3 rounded-md text-sm md:mt-0 mt-3">
                            ...
                            <div
                                ...
                                <a href="timeline-group.html" iv=""
                                    class="w-16 h-16 flex-shrink-0 overflow-hidden rounded-full relative">
                                    <img src="/../frontend/assets/images/group/group-5.jpg"
                                        class="absolute w-full h-full inset-0 " alt="">
                                </a>
                                <div class="flex-1">
                                    <a href="timeline-page.html" class="text-base font-semibold capitalize"> Property
                                        Rent </a>
                                    <div class="text-sm text-gray-500"> 54 mutual friends </div>
                                </div>
                                <button class="bg-gray-100 font-semibold py-2 px-3 rounded-md text-sm md:mt-0 mt-3">
                    ...
                    <div class="card md:p-6 p-2 max-w-3xl mx-auto">
                        ...
                        <div class="grid md:grid-cols-3 grid-cols-2  gap-x-2 gap-y-4 mt-3">
                            ...
                            <div>
                                <a href="video-watch.html"
                                    class="w-full h-36 overflow-hidden rounded-lg relative block">
                                    <img src="/../frontend/assets/images/video/img-2.png" alt=""
                                        class="w-full h-full absolute inset-0 object-cover">
                                    <span
                                        class="absolute bg-black bg-opacity-60 bottom-1 font-semibold px-1.5 py-0.5 right-1 rounded text-white text-xs">
                                        12:21</span>
                            ...
                            <div>
                                <a href="video-watch.html"
                                    class="w-full h-36 overflow-hidden rounded-lg relative block">
                                    <img src="/../frontend/assets/images/video/img-3.png" alt=""
                                        class="w-full h-full absolute inset-0 object-cover">
                                    <span
                                        class="absolute bg-black bg-opacity-60 bottom-1 font-semibold px-1.5 py-0.5 right-1 rounded text-white text-xs">
                                        12:21</span>
                            ...
                            <div>
                                <a href="video-watch.html"
                                    class="w-full h-36 overflow-hidden rounded-lg relative block">
                                    <img src="/../frontend/assets/images/video/img-4.png" alt=""
                                        class="w-full h-full absolute inset-0 object-cover">
                                    <span
                                        class="absolute bg-black bg-opacity-60 bottom-1 font-semibold px-1.5 py-0.5 right-1 rounded text-white text-xs">
                                        12:21</span>
                            ...
                            <div>
                                <a href="video-watch.html"
                                    class="w-full h-36 overflow-hidden rounded-lg relative block">
                                    <img src="/../frontend/assets/images/video/img-5.png" alt=""
                                        class="w-full h-full absolute inset-0 object-cover">
                                    <span
                                        class="absolute bg-black bg-opacity-60 bottom-1 font-semibold px-1.5 py-0.5 right-1 rounded text-white text-xs">
                                        12:21</span>
                            ...
                            <div>
                                <a href="video-watch.html"
                                    class="w-full h-36 overflow-hidden rounded-lg relative block">
                                    <img src="/../frontend/assets/images/video/img-6.png" alt=""
                                        class="w-full h-full absolute inset-0 object-cover">
                                    <span
                                        class="absolute bg-black bg-opacity-60 bottom-1 font-semibold px-1.5 py-0.5 right-1 rounded text-white text-xs">
                                        12:21</span>
            ...
            <div class="flex flex-1 items-start space-x-4 p-5">
                ...
                <div class="flex-1 pt-2">
                    <textarea
                        ...
                        rows="5" placeholder="¿Que estas pensando? {{ auth()->user()->name }}"></textarea>
                </div>
