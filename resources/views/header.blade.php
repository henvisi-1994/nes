                ...
                @if (auth()->user())
                    ...
                    <div uk-drop="mode: click" class="header_dropdown dropdown_cart">
                            ...
                            <div class="dropdown_scrollbar" data-simplebar>
                                <div class="drop_headline">
                                    ...
                                    <div class="btn_action">
                                        ...
                                        <a href="#" id="checkbox-outline-notifs" data-tippy-placement="left"
                        ...
                        <a href="#" class="is_icon" uk-tooltip="title: Message">
                            ...
                            @if (isset($notifications_messages))
                            ...
                            <div class="dropdown_scrollbar" data-simplebar>
                                <div class="drop_headline">
                                    ...
                                    <div class="btn_action">
                                        ...
                                        <a href="#" id="checkbox-outline-messages" data-tippy-placement="left"
                                            title="Mark as read all">
                                            <ion-icon name="checkbox-outline"></ion-icon>
                                        </a>
                                    </div>
                                        ...
                                        @forelse ($notifications_messages as $message)
                                            <li class="un-read">
                                                <a href="/messages/{{ $message->messagingUserID }}">
                                                    ...
                                                    <div class="drop_text">
                                                        <strong> {{ $message->messagingUserName }} </strong>
                                                        <time>12:43
                                                            PM</time>
                                                        <p> {{ $message->message }} </p>
                                                    </div>
